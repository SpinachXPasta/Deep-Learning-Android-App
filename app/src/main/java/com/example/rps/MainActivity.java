...
public class MainActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public void YOLO(View Button){
        ...
        if (startYolo == false){
            ...
            if (firstTimeYolo == false){
                ...
                Log.d("My storage dir","My Storage dir" + tinyYoloWeights);
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        if (startYolo == true) {
            ...
            Log.d("this is my Matrix", "arr: " + holder);
            ...
            for (int i = 0; i < result.size(); ++i)
            {
                ...
                for (int j = 0; j < level.rows(); ++j)
                {
                    ...
                    Log.d("this is my confidence", "arr: " + Float.toString(confidence));
            ...
            if (ArrayLength>=1) {
                ...
                for (int i = 0; i < ind.length; ++i) {
                    ...
                    List<String> rpsNames = Arrays.asList("scissors","papers","rock");
                    ...
                    Imgproc.putText(frame,rpsNames.get(idGuy) + " " + intConf + "%",box.tl(),Core.FONT_HERSHEY_SIMPLEX, 2, new Scalar(255,255,0),2);
